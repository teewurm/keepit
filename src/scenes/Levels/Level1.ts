...
export default class Level1 extends MazeSceneBase {
    ...
    protected readonly startItems: ItemWithIndex[] = [
        ...
        { index: { x: 12, y: 3 }, item: { damageType: DamageType.Void, type: ItemType.INFO_CARD } },
        { index: { x: 11, y: 3 }, item: { damageType: DamageType.Void, type: ItemType.INFO_CARD } },
        { index: { x: 10, y: 3 }, item: { damageType: DamageType.Void, type: ItemType.INFO_CARD } },
        ...
        { index: { x: 3, y: 1 }, item: { damageType: DamageType.Void, type: ItemType.INFO_CARD } }
    ];
